...
def main():
    ...
    print("\nThe midpoint parameter was adjusted to ensure that:")
    print("- A raw score of 0.20 gives a matching percentage of 90%")
    print("- A raw score of 0.25 gives a matching percentage of ~82%")
    print("- All scores below 0.20 have >90% matching")
