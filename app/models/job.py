from sqlalchemy import Column, Integer, String, ForeignKey, DateTime, Text, UniqueConstraint, Float
...
class Job(Base):
    ...
    __table_args__ = (
        UniqueConstraint('location_id', 'apply_link', name='unique_location_apply_link'),
    ) 
